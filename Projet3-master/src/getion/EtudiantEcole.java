...
public class EtudiantEcole {
	...
	private static void insertEtudiant(Etudiant etudiant)
	{
		// Information d'acc�s � la base de donn�es
		String url = "jdbc:mysql://localhost:8889/EtudiantEcole";
		String login = "root";
		...
		try
		{
			...
			String query ="insert into Etudiant values ("+etudiant.getNumEtudiant()+","+etudiant.getNomEtudiant()+","+etudiant.getPrenomEtudiant()+")";
			statement.executeUpdate(query);
		}
		catch (SQLException e)
		{
	...
	private static void updateEtudiant(Etudiant etudiant)
	{
		// Information d'acc�s � la base de donn�es
		String url = "jdbc:mysql://localhost:8889/EtudiantEcole";
		String login = "root";
		...
		try
		{
			...
			String query ="UPDATE Etudiant SET nomEtudiant = "+etudiant.getNomEtudiant()+", prenomEtudiant ="+etudiant.getPrenomEtudiant()+" WHERE numEtudiant ="+ etudiant.getNumEtudiant();
			statement.executeUpdate(query);
		}
		catch (SQLException e)
		{
	...
	public static void main(String[] args)
	{
		...
		creerBase();
		creerTable();
		insertEtudiant(new Etudiant("1","tonton","marcel"));
		//updateEtudiant(new Etudiant("1","giovanni","simon"));
